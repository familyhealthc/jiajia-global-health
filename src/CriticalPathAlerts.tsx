...
const alerts: AlertItem[] = [
  ...
  {
    code: 'EU+', region: { zh: '欧洲逐国准入', en: 'European country-by-country access' },
    trigger: { zh: '药房网站 / 诊所医院 / 非欧盟分线', en: 'Pharmacy sites / care facilities / non-EU tracks' },
    start: { zh: '法国先找合资格实体药房并核事前申报；西班牙核药房直售、不得由平台中介；瑞典药房远程电商提前至少两个月申报；其他欧盟国家逐一核药房和医疗设施许可。英国及瑞士另立准入工作流。', en: 'Check eligible physical-pharmacy and prior-declaration rules in France, direct pharmacy sales without marketplace intermediation in Spain, and Sweden’s at-least-two-month advance notice for pharmacy e-commerce. Review each other EU country’s pharmacy and care permits separately; run separate UK and Swiss tracks.' },
    gate: { zh: '欧盟共同器械规则不能替代各国药房、诊所或医院牌照；瑞士不属欧盟，不能直接沿用欧盟或英国准入。', en: 'EU device rules do not replace national pharmacy, clinic or hospital licences. Switzerland is outside the EU; neither EU nor UK access transfers automatically.' },
    sources: [
      ...
      { title: '西班牙 AEMPS', url: 'https://www.aemps.gob.es/informa/medIlegales/informacion-sobre-la-venta-de-medicamentos-a-traves-de-sitios-web-y-aplicaciones-para-moviles/' },
      { title: '瑞典药监局', url: 'https://www.lakemedelsverket.se/sv/handel-med-lakemedel/apotek/distans--och-e-handel-pa-apotek' },
      { title: '瑞士 Swissmedic', url: 'https://www.swissmedic.ch/swissmedic/en/home/humanarzneimittel/market-surveillance/medicinal-products-from-the-internet/leitfaden-arzneimittel-aus-dem-internet.html' },
